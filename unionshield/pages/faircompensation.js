    ...
    render(){
        return (
          <div>
            ...
            <Navbar />
            <SurveyContent type="fairCompensation" changeArray={this.changeArray} />
            ...
            {this.state.showResults &&
              <Card className="content m-5 p-5">
                <h2>Your Fair Compensation score for {this.state.employerInput} is:
                {' ' + parseInt(100 * ((this.state.arrScores[0])+3)/36)}%</h2>
