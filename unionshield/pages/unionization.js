...
export default class Unionization extends React.Component {
    ...
    render(){
        return (
          <div>
            <Head>
              <title>Unionization Survey | Union Shield</title>
              <link rel="icon" href="smalllogo.png" />
            </Head>

            <Navbar />
            <SurveyContent type="unionization" changeArray={this.changeArray} />
            ...
            {this.state.showResults &&
              <Card className="content m-5 p-5">
                <h2>Your Unionization and Independence score for {this.state.employerInput} is:
                {' ' + parseInt(100 * ((this.state.arrScores[3])+3)/19)}%</h2>
